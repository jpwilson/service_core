...
const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  // Latest changes (2026-03-22 evening)
  { date: '2026-03-22', category: 'Feature', description: 'Demo mode toggle: 1 second = 20 minutes for fast demonstrations' },
  { date: '2026-03-22', category: 'Feature', description: 'Driver UX split: My Equipment, My Schedule (read-only), pre-assigned routes with Mark Complete' },
  { date: '2026-03-22', category: 'Feature', description: 'Computed anomaly detection from real timesheet data (rounding, OT gaming, mileage, buddy punching)' },
  { date: '2026-03-22', category: 'Feature', description: 'Live team activity feed updates every 30 seconds' },
  { date: '2026-03-22', category: 'Feature', description: 'Equipment scaled to 80 units with driver assignments' },
  { date: '2026-03-22', category: 'Feature', description: 'Clock in/out creates real TimeEntry records with persistence (localStorage)' },
  { date: '2026-03-22', category: 'Feature', description: 'Breaks pause the main timer, warn after 30 minutes' },
  { date: '2026-03-22', category: 'Feature', description: 'Edit button on recent time entries to adjust hours' },
  { date: '2026-03-22', category: 'Feature', description: 'Import sample data buttons (Excel and OCR) with duplicate detection' },
  { date: '2026-03-22', category: 'Feature', description: 'Invoice PDF download generates real PDF via jspdf' },
  { date: '2026-03-22', category: 'Feature', description: 'Role-filtered notifications: drivers see their own, admins see admin alerts' },
  { date: '2026-03-22', category: 'Improvement', description: 'Scheduling renamed from Job Sites to Service Routes (North, South, East, West, Metro)' },
  { date: '2026-03-22', category: 'Improvement', description: 'Project changeable mid-shift in Advanced time clock mode' },
  { date: '2026-03-22', category: 'Feature', description: 'Sentry error monitoring with live DSN and browser tracing' },
  { date: '2026-03-22', category: 'Feature', description: '4-tab help hub: Chat, Glossary (19 terms), Changelog, Info' },
  { date: '2026-03-22', category: 'Feature', description: 'Custom favicon, SEO meta tags, Open Graph, robots.txt' },
  { date: '2026-03-22', category: 'Feature', description: 'README rewritten with all 22 gold standard sections, DESIGN.md, .env.example' },
  { date: '2026-03-22', category: 'Feature', description: '50 agent eval test cases in /evals/ (on-topic, off-topic, adversarial, tone)' },
  { date: '2026-03-22', category: 'Improvement', description: 'Date range picker hidden on tabs where irrelevant (time clock, routes, equipment)' },
  { date: '2026-03-22', category: 'Improvement', description: 'Access level badges on login page (pink highlight with underline)' },
  // Earlier 2026-03-22
  { date: '2026-03-22', category: 'Feature', description: '3D data visualization graph with react-force-graph-3d (dodecahedrons, particle pulses, insights)' },
  ...
  { date: '2026-03-22', category: 'Improvement', description: 'LLM Models section with purpose labels per model' },
  { date: '2026-03-22', category: 'Feature', description: 'Role-based access: drivers see 4 tabs, admins see 13' },
  { date: '2026-03-22', category: 'Improvement', description: 'Time Clock integrated into dashboard sidebar (no separate view)' },
  { date: '2026-03-22', category: 'Improvement', description: 'Landing page revamped: 12 features, daily workflow timeline, portable sanitation focused' },
  { date: '2026-03-22', category: 'Fix', description: 'Route Planning data moved from Tucson to Colorado Front Range' },
  { date: '2026-03-22', category: 'Improvement', description: 'Guided tour: 15 steps, positions next to sidebar, no bouncing arrow' },
  { date: '2026-03-22', category: 'Feature', description: 'Route Planning: 50 Colorado locations, OSRM real road routing, simulated traffic' },
